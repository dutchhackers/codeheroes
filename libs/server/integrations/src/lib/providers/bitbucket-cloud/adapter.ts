...
export class BitbucketCloudAdapter implements ProviderAdapter {
  readonly providerName = 'bitbucket_cloud';
  ...
  validateWebhook(
    ...
    if (!eventType || !eventId) {
      return { isValid: false, error: 'Missing required Bitbucket Cloud webhook headers' };
    }
  ...
  private handlePullRequestWebhook(
    webhook: BitbucketCloudPullRequestWebhook,
    uid: string,
  ): GameActionResult {
