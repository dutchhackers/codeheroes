...
export function printHeader(): void {
  console.log(`\n${COLORS.bright}Bitbucket Cloud Event Simulator${COLORS.reset}`);
...
export function printSending(url: string, requestId: string): void {
  console.log(`\n${COLORS.dim}Request UUID: ${requestId}${COLORS.reset}`);
